    ...
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetalleAsignacionPuntos", x => x.IdDetalle);
                    table.ForeignKey(
                        name: "FK_DetalleAsignacionPuntos_AsignacionesPuntos_IdAsignacion",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetalleAsignacionPuntos_IdAsignacion",
                table: "DetalleAsignacionPuntos",
                column: "IdAsignacion");
        }
